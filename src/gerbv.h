...
#else
#define GERB_FATAL_ERROR(...)		printf(__VA_ARGS__)
#define GERB_COMPILE_ERROR(...)		printf(__VA_ARGS__)
#define GERB_COMPILE_WARNING(...)	printf(__VA_ARGS__)
#define GERB_MESSAGE(...)			printf(__VA_ARGS__)
#endif
